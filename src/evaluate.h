...
static constexpr int endgamePhaseScore = 518;

// game phases
static constexpr int openingPhase = 0;
static constexpr int endgamePhase = 1;
static constexpr int middlegamePhase = 2;
...
// positional score for each piece [phase][piece][square]
static constexpr int PSQT[2][6][64] = {
    {
        // pawn
        {
        0,   0,   0,   0,   0,   0,  0,   0,
...
// flip black's perspective to white's
static constexpr int FLIP_SQ[2][64] = {
    {
...
static constexpr int materialScore[2][6] = {
